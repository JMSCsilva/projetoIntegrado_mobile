...
const Dermatologia = ({ navigation }) => {  // Desestruturação para extrair navigation
  return (
    <View style={styles.container}>
      ...
      <View style={styles.profileContainer}>
        ...
        <View style={styles.infoContainer}>
          ...
          <Text style={styles.doctorSpecialty}>Dermatologia</Text>
      ...
      <TouchableOpacity 
        style={styles.button}
        onPress={() => navigation.navigate('Atendimento')}  // Navegação para a tela de Atendimento
      >
